/**
 * Default categories seeded when a new user registers (or logs in via
 * OAuth for the first time). Inlined from the former
 * @sasha-licenta/shared workspace package so the backend deploys in
 * isolation on Railway.
 */
